...
/*   Updated: 2023/09/10 17:58:28 by feralves         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "Default constructor called, ClapTrap Droid created" << std::endl;
	return ;
}

ClapTrap::ClapTrap(std::string name) : _name(name), _hitPoints(10), _energyPoints(10), _attackDamage(0) 
{
	std::cout << "Name constructor called, ClapTrap " << _name << " created" << std::endl;
	return ;
}

ClapTrap::ClapTrap(const ClapTrap& copy)
{
	std::cout << "Copy constructor called for " << copy.getName() << " ClapTrap" << std::endl;
	*this = copy;
	return ;
}
...
{
	std::cout << "Default destructor called, ClapTrap " << _name << " is gone." << std::endl;
	return ;
}
...
{
	std::cout << "Copy assignment operator called for " << other.getName() << " ClapTrap" << std::endl;
	if (this != &other)
	{
...
{
	outputFile	<< "\t ClapTrap " << r.getName() << std::endl
