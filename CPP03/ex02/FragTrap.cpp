...
/*   Updated: 2023/09/10 17:54:43 by feralves         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "Default destructor called, FragTrap " << getName() << " is gone." << std::endl;
	return ;
}
...
void	FragTrap::highFivesGuys(void)
{
	...
	{
		std::cout << "FragTrap " << getName() << " is exausthed and can't enter high five mode!" << std::endl;
		return ;
	}
	if ((int)_hitPoints <= 0)
	{
		std::cout << "FragTrap " << getName() << " is unable to enter high five mode for lack of life!" << std::endl;
		return ;
	}
	setEnergyPoints(_energyPoints - 1);
	//FragTrap <name> attacks <target>, causing <damage> points of damage!
	std::cout << "FragTrap " << getName() << " gives everyone a high five!" << std::endl;
}
